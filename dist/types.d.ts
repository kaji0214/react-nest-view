...
export declare type ComponentsProps<T> = {
    ...
    Node: (props: NodeComponentProps<T>) => React.ReactElement<NodeComponentProps<T>>;
};
...
export declare type ReactNestViewType = <T>(props: ReactNestViewProps<T>) => React.ReactElement<ReactNestViewProps<T>>;
