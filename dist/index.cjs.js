...
const Node = ({ node, style }) =>
  /*#__PURE__*/ React.createElement(
    ...
    'nodes length is ',
    node.nodes && node.nodes.length ? node.nodes.length : 0
  )
...
const List = ({ children, style }) =>
  /*#__PURE__*/ React.createElement(
    'div',
    {
      className: 'react-nest-view--list',
      style: style,
    },
    children
  )
...
const defaultComponents = (custom) => ({ ...components, ...custom })
...
const defaultStyles = (custom) => ({ ...stylesFunctions, ...custom })
...
const Nest = ({
  ...
  const [isNodeOpen, setIsNodeOpen] = react.exports.useState(isOpen)
  const [nodes, setNodes] = react.exports.useState(node.nodes ?? [])
  const nodeState = {
    depth,
    isNodeOpen,
  }
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    nodes &&
      ...
      /*#__PURE__*/ React.createElement(
        ListComponent,
        {
          style: getStyles('list', {
            depth: 1 + depth,
            isNodeOpen,
          }),
        },
        nodes.map((item, index) =>
          /*#__PURE__*/ React.createElement(Nest, {
            key: index,
...
const ReactNestView = ({ nodes, isOpen = true, styles, components }) => {
  const { Container, List, Node } = defaultComponents(components)
  const mergedStyle = defaultStyles(styles)

  const getStyles = (key, props) => mergedStyle[key](baseStyle[key], props)
...
exports.ReactNestView = ReactNestView
